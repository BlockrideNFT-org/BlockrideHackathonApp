...
export default function SectionThree() {
  return (
    <div className="content mt-12 mb-20 w-5/6 m-auto mobile:mt-8 mobile:mb-0">
      ...
      <div className="mt-12 py-6 pl-14 text-[16px] text-secondary-orange border bg-secondary-orange/10 border-secondary-orange rounded-xl font-normal leading-8 mobile:py-3 mobile:px-8 mobile:mt-9">
      ...
      <div className="mt-12 flex text-2xl mobile:flex-col">
