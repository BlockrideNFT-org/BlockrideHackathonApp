...
function DetailsCard({ cardType, position }: DetailsCardProps) {
  const cardContent: Record<string, JSX.Element> = {
    totalInvested: (
      <div className="mobile:flex mobile:flex-row-reverse mobile:items-center mobile:justify-between">
        <span className="text-6xl ml-2 leading-5 flex items-center font-bold mobile:mt-0 mobile:ml-0">
          <img
        ...
        <p className="mt-6 mx-4 leading-8 text-[16px] text-secondary-text mobile:mt-0 mobile:mx-0 mobile:leading-[20px] mobile:text-[14px]">
          Total Invested
        </p>
      </div>
    ),
    totalReturns: (
      <div className="mobile:flex mobile:flex-row-reverse mobile:items-center mobile:justify-between">
        ...
        <span className="mt-6 mx-4 flex justify-between leading-8 text-[16px] text-secondary-text mobile:inline mobile:mt-0 mobile:mx-0">
  ...
  return (
    <>
      <div
        className={`border border-[#29231B] whitespace-nowrap pt-12 py-16 pl-16 pr-14 rounded-2xl 
